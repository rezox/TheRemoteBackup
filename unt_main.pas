...
uses
  ...
  sqldb, LCLType, ExtCtrls, LMessages, PopupNotifier, ftpsend, IniFiles;
...
begin
  ...
  begin
    FtpPutFile(frm_main.aServer, frm_main.aPort, frm_main.aFtpRepoPath +
      sql.FieldByName('filename').AsString,
      sql.FieldByName('filepath').AsString, frm_main.aFtpUser, frm_main.aFtpPasswd);
